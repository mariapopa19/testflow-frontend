            ...
            <TableBody>
              {currentData.map((item, i) => (
                <TableRow key={i + 1}>
                  ...
                  <TableCell className={`px-4 py-3 font-normal dark:text-gray-400/90 text-gray-800 border border-gray-100 dark:border-white/[0.05] text-theme-sm whitespace-nowrap ${methodBadgeColor(item.method)}`}>
                    {item.method}
                  </TableCell>
                  ...
                  {/*TODO: add this buttons whre you want to start the tests, edit and delete*/}
                  <TableCell className="text-right space-x-2">
                    ...
                    <button className="btn-icon btn-destructive">
